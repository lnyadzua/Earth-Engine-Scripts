...
var red = l5_2011_12mos.select('B3');
var ndvi_2011_12 = nir.subtract(red).divide(nir.add(red)).rename('NDVI_2011_12');

Map.centerObject(l5_2011_12mos,9);// Mapcenter object(geometry used previously,zoom level which is between 1 to 24)
var ndviParams2011_12 = {min: -1, max: 1, pallete: ['blue', 'white', 'green','red']};//visualization parameter
Map.addLayer(ndvi_2011_12, ndviParams2011_12,'NDVI_2011_12');// (object to add to map, visualization parameters,name of layer)

print('ndvi_2011_12', ndvi_2011_12);

//to iterate for all collection to ndvi
var ndvi_2011_12mosCol = function(image){
  var nir = l5_2011_12mos.select('B4');
  var red = l5_2011_12mos.select('B3');
  var ndvi_2011_12 = nir.subtract(red).divide(nir.add(red)).rename('NDVI_2014');
  return image.addBands(ndvi_2011_12);
}; 

ndvi_2011_12mosCol = l5_2011_12.map(ndvi_2011_12mosCol);

print('ndvimoscol2011_12', ndvi_2011_12mosCol);
