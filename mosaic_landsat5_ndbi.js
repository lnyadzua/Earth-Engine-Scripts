...
var ndbi_2011_12 = swir.subtract(nir).divide(swir.add(nir)).rename('NDBI_2011_12');

Map.centerObject(l5_2011_12mos,9);// Mapcenter object(geometry used previously,zoom level which is between 1 to 24)
var ndbiParams2011_12 = {min: -1, max: 1, pallete: ['blue', 'white', 'green']};//visualization parameter
Map.addLayer(ndbi_2011_12, ndbiParams2011_12,'NDBI_2011_12');// (object to add to map, visualization parameters,name of layer)

print('ndbi_2011_12', ndbi_2011_12);

//to iterate for all collection to ndvi
var ndbi_2011_12mosCol = function(image){
  var swir = l5_2011_12mos.select('B5');
  var nir = l5_2011_12mos.select('B4');
  var ndbi_2011_12 = swir.subtract(nir).divide(swir.add(nir)).rename('NDBI_2014');
  return image.addBands(ndbi_2011_12);
}; 

ndbi_2011_12mosCol = l5_2011_12.map(ndbi_2011_12mosCol);

print('ndbimoscol2011_12', ndbi_2011_12mosCol);
