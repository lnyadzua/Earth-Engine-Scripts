...
var fe = ee.FeatureCollection('users/lmbwia/farmextracted');
Map.addLayer(fe, {}, 'farmextracted');
...
// //wrap the feature in a Feture Colection for export
// var ndvitscol = ee.FeatureCollection([ndvits]);

// //Export a .csv table of date, mean NDVI for farmpolygons

Export.table.toDrive({
  collection:ndvits ,
  description: 'fetableGEO',
  fileFormat: 'GEOJSON'
});
